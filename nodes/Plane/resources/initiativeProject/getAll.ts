...
export const initiativeProjectGetAllDescription: INodeProperties[] = [
	{
		...
		default: '',
		required: true,
		description: 'The ID of the initiative to list projects for',
		displayOptions: {
			show: showFor,
		},
	},
...
export async function initiativeProjectGetAll(
