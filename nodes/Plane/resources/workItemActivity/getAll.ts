...
export const workItemActivityGetAllDescription: INodeProperties[] = [
	{
...
export async function workItemActivityGetAll(
	...
	const results = await planeRequestOffsetAllItems.call(
		...
		{
			method: 'GET',
			url: API_ENDPOINTS.WORK_ITEM_ACTIVITIES(slug, projectId, workItemId),
		},
		returnAll,
		limit,
	);
