...
import { getWorkspaceSlug, planeRequestCursorAllItems, rlcValue } from '../../utils/helpers';
...
export const workItemGetAllDescription: INodeProperties[] = [
	projectRlc(showFor),
	{
...
export async function workItemGetAll(
