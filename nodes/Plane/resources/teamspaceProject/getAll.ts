...
export const teamspaceProjectGetAllDescription: INodeProperties[] = [
	{
		...
		default: '',
		required: true,
		description: 'The ID of the teamspace to retrieve projects from',
		displayOptions: {
			show: showFor,
		},
	},
...
export async function teamspaceProjectGetAll(
