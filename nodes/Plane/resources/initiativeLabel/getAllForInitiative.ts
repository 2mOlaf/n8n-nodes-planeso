...
const showFor = {
	operation: ['getAllForInitiative'],
	resource: ['initiativeLabel'],
};

export const initiativeLabelGetAllForInitiativeDescription: INodeProperties[] = [
	{
		...
		default: '',
		required: true,
		description: 'The ID of the initiative to list labels for',
		displayOptions: {
			show: showFor,
		},
	},
...
export async function initiativeLabelGetAllForInitiative(
